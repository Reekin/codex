...
use crate::chat_tree::ChatTreeProjectionSnapshot;
...
impl CodexThread {
    ...
    pub async fn chat_tree_projection(&self) -> ChatTreeProjectionSnapshot {
        self.codex.session.chat_tree_projection().await
    }
