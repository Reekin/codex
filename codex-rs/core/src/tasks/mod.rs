...
impl Session {
    ...
    pub async fn on_task_finished(
        ...
        if has_chat_tree {
            ...
            tokio::spawn(async move {
                sess.run_async_chat_tree_summary_job(turn_context, last_agent_message_for_summary)
                    .await;
            });
        } else {
            warn!(
    ...
    async fn run_async_chat_tree_summary_job(
        ...
        info!(
            ...
            request_payload = request_payload.as_str(),
        ...
        info!(
            ...
            response_payload = response_payload.as_str(),
