...
async fn shell_family_registers_visible_unified_exec_and_hidden_legacy_shell() {
    ...
    plan.assert_registered_contains(&["exec_argv", "exec_command", "write_stdin", "shell_command"]);
...
async fn shell_zsh_fork_stays_standalone_until_unified_exec_composition_is_enabled() {
    ...
    standalone.assert_visible_lacks(&["exec_argv", "exec_command", "write_stdin"]);
    standalone.assert_registered_contains(&["shell_command"]);
    standalone.assert_registered_lacks(&["exec_argv", "exec_command", "write_stdin"]);
    ...
    if codex_utils_pty::conpty_supported() {
        ...
        composed.assert_visible_lacks(&["exec_argv", "exec_command", "write_stdin"]);
    }
}
