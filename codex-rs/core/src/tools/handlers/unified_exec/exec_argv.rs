...
impl ExecArgvHandler {
    async fn handle_call(
        ...
        let sandbox = codex_sandboxing::SandboxManager::new().select_initial(
        ...
        let native_cwd = match cwd.to_abs_path() {
            ...
            _ if sandbox == codex_sandboxing::SandboxType::None => None,
        ...
        match manager
            .exec_command(
                ExecCommandRequest {
                    ...
                    shell_mode: super::shell_mode_for_environment(
