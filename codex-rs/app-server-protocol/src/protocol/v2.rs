...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadChatTreeReadParams {
    pub thread_id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadChatTreeReadResponse {
    pub thread_id: String,
    pub chat_tree: ThreadChatTree,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadChatTreeSetCurrentParams {
    pub thread_id: String,
    pub node_id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadChatTreeSetCurrentResponse {
    pub thread_id: String,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadChatTreeTurnInfo {
    pub node_id: String,
    pub parent_node_id: Option<String>,
    pub summary: Option<String>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadChatTreeNodeUpdatedNotification {
    pub thread_id: String,
    pub chat_tree: ThreadChatTreeTurnInfo,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadChatTreeCurrentNodeChangedNotification {
    pub thread_id: String,
    pub node_id: String,
}
