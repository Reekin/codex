...
Use this matrix for detailed test coverage. Use `acceptance-checklist.md` as the final migration acceptance checklist.
...
- Stable `chatTree/read` request/response JSON fixtures match `app-server-compat.md`.
- Stable `chatTree/setCurrent` request/response JSON fixtures match `app-server-compat.md`.
- Stable `chatTree/updated` notification JSON fixtures match `app-server-compat.md`.
