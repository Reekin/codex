...
Final migration acceptance is owned by `acceptance-checklist.md`. Use these app-server-specific checks as supporting evidence when the app-server protocol, schema, notifications, or selected-branch transcript behavior is touched:
